- dashboard: leaderboard__bookings_ytd
  ...
  - title: Bookings YTD
    ...
    color_application:
      ...
      options:
        steps: 5
        __FILE: app-sales/sales_rep_leaderboard_bookings_ytd.dashboard.lookml
        __LINE_NUM: 31
    ...
    y_axes: [{label: '', orientation: left, series: [{id: opportunity.total_closed_won_new_business_amount,
        ...
        tickDensity: default, type: linear, __FILE: app-sales/sales_rep_leaderboard_bookings_ytd.dashboard.lookml,
        __LINE_NUM: 47}]
