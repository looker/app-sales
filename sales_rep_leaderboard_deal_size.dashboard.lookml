- dashboard: sales_rep_leaderboard_deal_size
  ...
  - title: Avg Deal Size
    ...
    explore: opportunity
    type: looker_bar
    fields: [opportunity_owner.name, opportunity.average_new_deal_size_won, opportunity_owner.rep_highlight_average_new_deal_size_won]
    filters:
    ...
    limit: 15
    column_limit: 50
    dynamic_fields: [{table_calculation: rep_highlight, label: Rep Highlight, expression: 'if(is_null(${opportunity_owner.rep_highlight_average_new_deal_size_won}),
          null,${opportunity.average_new_deal_size_won})', value_format: '[>=1000000]$0.00,,"M";[>=1000]$0,"K";$0.00',
