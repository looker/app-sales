- dashboard: pipeline_management
  ...
  - title: Pipeline Revenue QTD
    ...
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: gap, label: Gap, expression: "${quota_numbers.quarterly_aggregate_quota_measure}\
  ...
  - title: Pipeline Revenue MTD
    ...
    explore: opportunity
    type: single_value
    fields: [opportunity.total_pipeline_new_business_amount, quota_numbers.monthly_aggregate_quota_measure,
      opportunity.total_closed_won_new_business_amount]
    filters:
      opportunity.close_date: this month
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: gap, label: Gap, expression: "\n# Gap\n(${quota_numbers.monthly_aggregate_quota_measure}\
          \ - ${opportunity.total_closed_won_new_business_amount})", value_format: '[>=1000000]$0.00,,"M";[>=1000]$0.00,"K";$0.00',
        value_format_name: !!null '', _kind_hint: measure, _type_hint: number}]
    custom_color_enabled: true
    custom_color: ''
    ...
    comparison_reverse_colors: false
    show_comparison_label: true
    hidden_fields: [quota_numbers.monthly_aggregate_quota_measure, opportunity.total_closed_won_new_business_amount]
    listen: {}
    row: 0
    col: 0
    width: 6
  ...
  - title: Opps by Stage & Rep
    ...
    filters:
      opportunity.is_pipeline: 'Yes'
      opportunity.close_date: this quarter
    sorts: [opportunity.count_new_business desc 0]
    limit: 20
    trellis: ''
    stacking: normal
    color_application:
