- dashboard: sales_rep_ramping
  ...
  - title: Average Days to Close (vs Segment)
    ...
    y_axes: [{label: '', orientation: left, series: [{id: "    Aditya Arya - sales_cycle",
            name: "    Aditya Arya", axisId: sales_cycle}, {id: "    Akira Igarashi\
              \ - sales_cycle", name: "    Akira Igarashi", axisId: sales_cycle},
          {id: "    Akshay Padhye - sales_cycle", name: "    Akshay Padhye", axisId: sales_cycle},
          {id: "    Alec Short - sales_cycle", name: "    Alec Short", axisId: sales_cycle}],
        showLabels: false, showValues: true, unpinAxis: false, tickDensity: default,
        type: linear}]
    y_axis_combined: true
    show_y_axis_labels: true
  ...
  - title: Win % (First 18 months vs Segment)
    ...
    limit_displayed_rows: false
    hidden_series: []
    y_axes: [{label: '', orientation: left, series: [{id: " Aditya Arya - average_win",
            name: " Aditya Arya", axisId: average_win}, {id: " Akira Igarashi - average_win",
            name: " Akira Igarashi", axisId: average_win}, {id: " Akshay Padhye -\
              \ average_win", name: " Akshay Padhye", axisId: average_win}, {id: " Alec\
              \ Short - average_win", name: " Alec Short", axisId: average_win}],
        showLabels: false, showValues: true, unpinAxis: false, tickDensity: default,
        type: linear}]
    y_axis_combined: true
    show_y_axis_labels: true
