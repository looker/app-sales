- dashboard: pipeline_velocity
  ...
  - title: 'Rep: Average Days in Stage'
    ...
    hidden_series: [Stage 2 - 3 - opportunity_stage_history.avg_days_in_stage, Stage
      ...
      Validate - 1 - opportunity_stage_history.avg_days_in_stage, Develop - 3 - opportunity_stage_history.avg_days_in_stage,
      Develop Positive - 4 - opportunity_stage_history.avg_days_in_stage, Sales Submitted
        - 6 - opportunity_stage_history.avg_days_in_stage, Closed Won - 7 - opportunity_stage_history.avg_days_in_stage,
      Negotiate - 5 - opportunity_stage_history.avg_days_in_stage]
  ...
  - title: 'Days in Pipeline: Top Deals'
    ...
    explore: opportunity
    type: looker_bar
    fields: [opportunity_stage_history.avg_days_in_stage, account.name, opportunity.total_closed_won_amount,
    ...
    sorts: [opportunity_stage_history.stage, total desc 0]
    limit: 2000
    dynamic_fields: [{table_calculation: total, label: Total, expression: 'sum(pivot_row(${opportunity.total_closed_won_amount}))',
        value_format: !!null '', value_format_name: usd_0, _kind_hint: supermeasure,
        _type_hint: number}]
