- dashboard: sales_rep_leaderboard_bookings_last_quarter
  ...
  - title: Bookings (Last Complete Quarter)
    ...
    fields: [opportunity_owner.name, opportunity.total_closed_won_new_business_amount,
      opportunity.total_closed_won_new_business_amount_hidden, opportunity.rep_highlight_acv]
    filters:
    ...
    color_application:
      ...
      options:
        steps: 5
        __FILE: app-sales/sales_rep_leaderboard_bookings_last_fiscal_quarter.dashboard.lookml
        __LINE_NUM: 31
    ...
    y_axes: [{label: '', orientation: left, series: [{id: opportunity.total_closed_won_new_business_amount,
        ...
        tickDensity: default, type: linear, __FILE: app-sales/sales_rep_leaderboard_bookings_last_fiscal_quarter.dashboard.lookml,
        __LINE_NUM: 47}]
